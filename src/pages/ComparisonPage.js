...
const ComparisonPage = () => {
  ...
  return (
    <div className="bg-dark text-white">
      <Helmet>
        <title>TestMasterHub vs Postman – Full Comparison</title>
        <meta
          name="description"
          content="Compare TestMasterHub with Postman: offline mode, AI features, Git sync, pricing, performance, and automation capabilities."
        />
      </Helmet>
        ...
        <div className="container py-5">
          <div className="row justify-content-center text-center">
            <div className="col-lg-10">
              ...
              >
                Compare the leading API testing platforms. See why TestMasterHub
                combines the best of offline security with AI-powered automation
                and seamless Postman migration.
              </p>
            </div>
          </div>
        </div>
                    ...
                    <div className="row align-items-center">
                      <div className="col-lg-8">
                        ...
                        <p className="mb-0 opacity-90">
                          Import your existing Postman collections directly into
                          TestMasterHub. Keep all your work while gaining
                          AI-powered features and enhanced security.
                        </p>
                      </div>
                    ...
                    <tbody>
                      {[
                        ...
                        },
                        {
                          ...
                          bruno: {
                            icon: <HardDrive className="text-warning" />,
                            text: "Plain Files",
                          },
                          postman: {
                            icon: <Cloud className="text-danger" />,
                            text: "Cloud Only",
                          },
                        },
                        {
                  ...
                  <div className="card-body p-4">
                    <div className="row text-center">
                      <div className="col-lg-4 mb-4 mb-lg-0">
                        <div
                          className="bg-gradient-pink-purple rounded-circle d-inline-flex align-items-center justify-content-center mb-3"
                        ...
                        <p className="text-white-50 small mb-0">
                          Git integration + encrypted sharing (roadmap)
                        </p>
                      </div>
                      <div className="col-lg-4 mb-4 mb-lg-0">
                        <div
                      ...
                      <div className="col-lg-4">
                        ...
                        <p className="text-white-50 small mb-0">
                          Cloud workspaces & real-time sync
                        </p>
                      </div>
                    </div>
                  </div>
        ...
        <div className="container">
          <div className="text-center">
            <h2 className="h3 fw-bold mb-3">
              Ready to upgrade your API testing?
            </h2>
            <p className="mb-4 opacity-90">
              Get AI-powered assertions, enterprise security, and seamless
              Postman migration.
            </p>
            <a
